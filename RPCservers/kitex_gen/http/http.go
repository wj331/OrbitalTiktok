...
type BizRequest struct {
	...
	Items []string `thrift:"items,6,optional" frugal:"6,optional,list<string>" json:"items,omitempty"`
}
...
var BizRequest_Items_DEFAULT []string

func (p *BizRequest) GetItems() (v []string) {
	if !p.IsSetItems() {
		return BizRequest_Items_DEFAULT
	}
	return p.Items
}
...
func (p *BizRequest) IsSetItems() bool {
	return p.Items != nil
}

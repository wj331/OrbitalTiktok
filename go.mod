module github.com/simbayippy/OrbitalxTiktok
...
require (
	...
	github.com/simbayippy/OrbitalxTiktok/RPCservers v0.0.0-20230703105004-bf3add89cd03
	golang.org/x/time v0.3.0
	google.golang.org/protobuf v1.31.0
)

require (
	github.com/aliyun/alibaba-cloud-sdk-go v1.62.446 // indirect
